...
const (
	Email_EMAIL_DOMAIN_TYPE_UNSPECIFIED Email_EmailDomainType = 0 // @exclude match API specifications
	Email_EMAIL_DOMAIN_TYPE_GMAIL       Email_EmailDomainType = 1 // google
	Email_EMAIL_DOMAIN_TYPE_YAHOO_JAPAN Email_EmailDomainType = 2 // yahoo japan
	Email_EMAIL_DOMAIN_TYPE_OUTLOOK     Email_EmailDomainType = 3 // ms outlook
	Email_EMAIL_DOMAIN_TYPE_OTHER       Email_EmailDomainType = 4 // other domains
)

// Enum value maps for Email_EmailDomainType.
var (
	Email_EmailDomainType_name = map[int32]string{
		0: "EMAIL_DOMAIN_TYPE_UNSPECIFIED",
		1: "EMAIL_DOMAIN_TYPE_GMAIL",
		2: "EMAIL_DOMAIN_TYPE_YAHOO_JAPAN",
		3: "EMAIL_DOMAIN_TYPE_OUTLOOK",
		4: "EMAIL_DOMAIN_TYPE_OTHER",
	}
	Email_EmailDomainType_value = map[string]int32{
		"EMAIL_DOMAIN_TYPE_UNSPECIFIED": 0,
		"EMAIL_DOMAIN_TYPE_GMAIL":       1,
		"EMAIL_DOMAIN_TYPE_YAHOO_JAPAN": 2,
		"EMAIL_DOMAIN_TYPE_OUTLOOK":     3,
		"EMAIL_DOMAIN_TYPE_OTHER":       4,
	}
)
...
type SampleResponse struct {
	...
	Person *Person `protobuf:"bytes,1,opt,name=person,proto3" json:"person,omitempty"` // person info
}
...
func (x *SampleResponse) GetPerson() *Person {
	if x != nil {
		return x.Person
	}
	return nil
...
type Person struct {
	...
	Emails []*Email `protobuf:"bytes,4,rep,name=emails,proto3" json:"emails,omitempty"` // his/her email
}
...
func (x *Email) GetDomain() Email_EmailDomainType {
	...
	return Email_EMAIL_DOMAIN_TYPE_UNSPECIFIED
}
...
var file_sample_proto_sample_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2b, 0x0a, 0x0d, 0x53, 0x61,
	...
	0x4e, 0x20, 0x00, 0x52, 0x02, 0x69, 0x64, 0x22, 0x38, 0x0a, 0x0e, 0x53, 0x61, 0x6d, 0x70, 0x6c,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x26, 0x0a, 0x06, 0x70, 0x65, 0x72,
	0x73, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x73, 0x61, 0x6d, 0x70,
	0x6c, 0x65, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x06, 0x70, 0x65, 0x72, 0x73, 0x6f,
	0x6e, 0x22, 0x65, 0x0a, 0x06, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x65, 0x12, 0x25, 0x0a, 0x06, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x0d, 0x2e, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x45, 0x6d, 0x61, 0x69, 0x6c,
	0x52, 0x06, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x8b, 0x02, 0x0a, 0x05, 0x45, 0x6d, 0x61,
	...
	,
...
var file_sample_proto_sample_proto_depIdxs = []int32{
	3, // 0: sample.SampleResponse.person:type_name -> sample.Person
	4, // 1: sample.Person.emails:type_name -> sample.Email
	0, // 2: sample.Email.domain:type_name -> sample.Email.EmailDomainType
	1, // 3: sample.AddressService.Search:input_type -> sample.SampleRequest
	2, // 4: sample.AddressService.Search:output_type -> sample.SampleResponse
